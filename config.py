...
def _league_on(env_name: str, default: bool = True) -> bool:
    return os.getenv(env_name, str(default)).lower() == "true"


WATCHED_LEAGUES = {
    "Premier League":            _league_on("LEAGUE_PREMIER_LEAGUE"),
    "La Liga":                   _league_on("LEAGUE_LA_LIGA"),
    "Serie A":                   _league_on("LEAGUE_SERIE_A"),
    "Bundesliga":                _league_on("LEAGUE_BUNDESLIGA"),
    "Ligue 1":                   _league_on("LEAGUE_LIGUE_1"),
    "Eredivisie":                _league_on("LEAGUE_EREDIVISIE"),
    "MLS":                       _league_on("LEAGUE_MLS"),
    "Brazil Série A":            _league_on("LEAGUE_BRAZIL_SERIE_A"),
    "Saudi Pro League":          _league_on("LEAGUE_SAUDI_PRO_LEAGUE"),
    "South African Premiership": _league_on("LEAGUE_SOUTH_AFRICAN_PREMIERSHIP"),
    "Malawi Super League":       _league_on("LEAGUE_MALAWI_SUPER_LEAGUE"),
    "Süper Lig":                 _league_on("LEAGUE_SUPER_LIG"),
}
...
WATCHED_LEAGUES_DEFAULT = _league_on("LEAGUE_DEFAULT", True)
